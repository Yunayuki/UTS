							...
							<table class="table table-hover" id='example'>
								...
								<?php foreach ($kategori as $key) { ?>
									<tr>
										...
										<td>
											<a href="<?php echo site_url('barang/index/').$key->id ?>" type="button" class="btn btn-primary">Barang</a>
											<a href="<?php echo site_url('kategori/update/').$key->id ?>" type="button" class="btn btn-success">Edit</a>
